...
public class ObtenerRegistradas extends AsyncTask<String, Integer, ArrayList<ArrayList<String>>>
{
	 ...
	 public ObtenerRegistradas(AsyncTaskListener asyncTaskListener) {
	...
	public static ArrayList<ArrayList<String>> obtener() 
	{
		...
		String METHOD_NAME = "wsMateriasRegistradas";
		String SOAP_ACTION = "http://tempuri.org/wsMateriasRegistradas";
		...
		try 
		{
			...
			for(int i =0; i<numero;i++){
				...
				materia.add(data.getProperty("NOMBRE").toString());
